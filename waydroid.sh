...
cd /tmp && git clone https://github.com/casualsnek/waydroid_script && cd waydroid_script && python3 -m venv venv && venv/bin/pip install -r requirements.txt && sudo venv/bin/python3 main.py install libndk # should be "libhoudini" for Intel CPUs, "libndk" for AMD CPUs
